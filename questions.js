questions = [
  ...
  {
        "question": "My religion should be enforced as the only religion by the state.",
        "effect": {
            "econ": 0,
            "dipl": 0,
            "govt": -15,
   ...
   {
        "question": "Our nation's values should be spread by force.",
        "effect": {
            "econ": 0,
            "dipl": -10,
            "govt": -10,
    ...
    {
        "question": "The general populace often makes poor decisions, and those decisions shouldn't influence policy.",
        "effect": {
            "econ": 0,
            "dipl": 0,
            "govt": -10,
    ...
    {
        "question": "Victimless crimes (such as drug use or Holocaust denial) should not be crimes at all.",
        "effect": {
            "econ": 0,
            "dipl": 0,
            "govt": 10,
    ...
    {
        "question": "Regardless of political opinions, it is important to side with your country's government.",
        "effect": {
            "econ": 0,
            "dipl": -10,
            "govt": -10,
    ...
    {
  {
        "question": "Religion should be restricted by the government",
        "effect": {
            "econ": 0,
            "dipl": 0,
            "govt": -10,
    ...
    },
    {
        ...
        "question": "Sexual behavior of consenting adults should be restricted by the government",
        "effect": {
            "econ": 0,
            "dipl": 0,
            "govt": -10,
    ...
    {
        "question": "Women should have equal rights to those of men",
        "effect": {
            "econ": 0,
            "dipl": 0,
            "govt": 10,
